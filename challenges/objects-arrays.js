...
let lowCaseAnimalNames = zooAnimals.map(x => 
  x.animal_name.toLowerCase());
...
*/
let lowPopulationAnimals = zooAnimals.filter(x => 
  x.population < 5);
...
*/
let populationTotal = zooAnimals.reduce((x, y) => {
  return x + y.population;}, 0);
